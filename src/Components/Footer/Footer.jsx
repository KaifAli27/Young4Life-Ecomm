            ...
            <div className="lg:container mx-auto">
                <div className="flex items-center justify-between pb-6">
                    ...
                    <div className="logo_wrapper">
                        <Link to={'/'}><h3 className='text-[2rem] text-[#484848] uppercase font-normal'>YoungForLife</h3></Link>
                    </div>
                ...
                <div className="flex items-center justify-center">
                    <p className='text-sm text-[#484848] font-poppins font-normal'>Copyright &copy; 20250 Y4L. All Rights Reserved</p>
                </div>
            </div>
        </div>
    );
