            ...
            <Swiper
                ...
                <SwiperSlide>
                    <div className='relative'>
                        <img className='w-full max-h-[582px] h-full object-cover' src="/deals/deal1.png" alt="deals one" />
                        <div className='absolute bottom-25 left-0 transform translate-y-1/2 translate-x-1/2 max-w-[217px] w-full max-h-[130px] h-full bg-white flex flex-col items-center justify-center gap-2.5 z-10'>
                            ...
                            <span className='text-xl text-[#484848] font-poppins capitalize font-medium'>10% off</span>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                <div className='relative'>
                        <img className='w-full max-h-[582px] h-full object-cover' src="/deals/deal2.png" alt="deals two" />
                        <div className='absolute bottom-25 left-0 transform translate-y-1/2 translate-x-1/2 max-w-[217px] w-full max-h-[130px] h-full bg-white flex flex-col items-center justify-center gap-2.5 z-10'>
                            <h5 className='text-base text-[#484848] font-poppins font-normal capitalize'>02- Spring sale</h5>
                            <span className='text-xl text-[#484848] font-poppins capitalize font-medium'>20% off</span>
                        </div>
                    </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                <div className='relative'>
                        <img className='w-full max-h-[582px] h-full object-cover' src="/deals/deal3.png" alt="deals tree" />
                        <div className='absolute bottom-25 left-0 transform translate-y-1/2 translate-x-1/2 max-w-[217px] w-full max-h-[130px] h-full bg-white flex flex-col items-center justify-center gap-2.5 z-10'>
                            <h5 className='text-base text-[#484848] font-poppins font-normal capitalize'>03- Spring sale</h5>
                            <span className='text-xl text-[#484848] font-poppins capitalize font-medium'>50% off</span>
                        </div>
                    </div>
                </SwiperSlide>
                ...
                <div className='relative'>
                        ...
                        <div className='absolute bottom-25 left-0 transform translate-y-1/2 translate-x-1/2 max-w-[217px] w-full max-h-[130px] h-full bg-white flex flex-col items-center justify-center gap-2.5 z-10'>
                            <h5 className='text-base text-[#484848] font-poppins font-normal capitalize'>01- Spring sale</h5>
                            <span className='text-xl text-[#484848] font-poppins capitalize font-medium'>35% off</span>
                        </div>
                    </div>
                </SwiperSlide>
